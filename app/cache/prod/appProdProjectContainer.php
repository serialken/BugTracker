...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bugtracker', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/sonata/admin', false);
    }
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array('admin' => array(0 => 'sonata.admin.block.admin_list'), 'cms' => array(0 => 'sonata.block.service.text', 1 => 'sonata.block.service.rss')));
    }
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), $this->get('validator.validator_factory'), $this->get('translator'), 'validators', array(0 => $this->get('doctrine.orm.validator_initializer')));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod',
            ...
            'session.save_path' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/prod/doctrine/orm/Proxies',
