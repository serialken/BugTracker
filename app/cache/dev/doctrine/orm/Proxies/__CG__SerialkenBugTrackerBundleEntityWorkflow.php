 ...
 */
class Workflow extends \Serialken\BugTrackerBundle\Entity\Workflow implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'id', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'project', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'stateWorkflow', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'name', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'slug', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'isEnable', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'description', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'createdAt', '' . "\0" . 'Serialken\\BugTrackerBundle\\Entity\\Workflow' . "\0" . 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Workflow $proxy) {
    ...
    public function removeState(\Serialken\BugTrackerBundle\Entity\StateWorkflow $stateWorkflow)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeState', array($stateWorkflow));

        return parent::removeState($stateWorkflow);
    }
