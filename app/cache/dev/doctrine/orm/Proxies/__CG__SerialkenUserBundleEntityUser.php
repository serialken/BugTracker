...
namespace Proxies\__CG__\Serialken\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Serialken\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'avatar', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'project', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'bugAuthor', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'bugInChargeOf', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'projects', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'lang', '' . "\0" . 'Serialken\\UserBundle\\Entity\\User' . "\0" . 'timezone', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addBugAuthor(\Serialken\BugTrackerBundle\Entity\Application $bugAuthor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBugAuthor', array($bugAuthor));

        return parent::addBugAuthor($bugAuthor);
    }
    ...
    public function removeBugAuthor(\Serialken\BugTrackerBundle\Entity\Application $bugAuthor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBugAuthor', array($bugAuthor));

        return parent::removeBugAuthor($bugAuthor);
    }
    ...
    public function getBugAuthor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBugAuthor', array());

        return parent::getBugAuthor();
    }
    ...
    public function addBugInChargeOf(\Serialken\BugTrackerBundle\Entity\Application $bugInChargeOf)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBugInChargeOf', array($bugInChargeOf));

        return parent::addBugInChargeOf($bugInChargeOf);
    }
    ...
    public function removeBugInChargeOf(\Serialken\BugTrackerBundle\Entity\Application $bugInChargeOf)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBugInChargeOf', array($bugInChargeOf));

        return parent::removeBugInChargeOf($bugInChargeOf);
    }
    ...
    public function getBugInChargeOf()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBugInChargeOf', array());

        return parent::getBugInChargeOf();
    }
