...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sizannia.editor.connector.php' => 'getSizannia_Editor_Connector_PhpService',
            'sizannia.editor.extension' => 'getSizannia_Editor_ExtensionService',
            'sizannia.editor.type' => 'getSizannia_Editor_TypeService',
            'sonata.admin.application' => 'getSonata_Admin_ApplicationService',
            ...
            'sonata.admin.comments' => 'getSonata_Admin_CommentsService',
            ...
            'sonata.admin.priority' => 'getSonata_Admin_PriorityService',
            'sonata.admin.project' => 'getSonata_Admin_ProjectService',
            ...
            'sonata.admin.state' => 'getSonata_Admin_StateService',
            'sonata.admin.stateworkflow' => 'getSonata_Admin_StateworkflowService',
            ...
            'sonata.admin.workflow' => 'getSonata_Admin_WorkflowService',
        ...
        $this->aliases = array(
            ...
            'sizannia_editor.connector' => 'sizannia.editor.connector.php',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/Resources');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Serialken\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Serialken\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Serialken\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Serialken\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Serialken\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'monolog.handler.doctrine' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['monolog.handler.doctrine'] = new \Monolog\Handler\StreamHandler('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/logs/doctrine.log', 100, true);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/logs/dev.log', 100, true);
    }
    ...
    protected function getMonolog_Logger_DoctrineService()
    {
        ...
        $instance->pushHandler($this->get('monolog.handler.doctrine'));
        $instance->pushHandler($this->get('monolog.handler.console'));
        $instance->pushHandler($this->get('monolog.handler.main'));
        $instance->pushHandler($this->get('monolog.handler.debug'));
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'sizannia.editor.connector.php' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sizannia\EditorBundle\Connector\Php A Sizannia\EditorBundle\Connector\Php instance.
     */
    protected function getSizannia_Editor_Connector_PhpService()
    {
        return $this->services['sizannia.editor.connector.php'] = new \Sizannia\EditorBundle\Connector\Php($this->get('request'), array('baseUrl' => '/uploads/', 'path' => '', 'baseDir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web', 'connector' => 'Core/connector/php/php5', 'license' => array('key' => '', 'name' => '')));
    }

    /**
     * Gets the 'sizannia.editor.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sizannia\EditorBundle\Twig\SizanniaEditorExtension A Sizannia\EditorBundle\Twig\SizanniaEditorExtension instance.
     */
    protected function getSizannia_Editor_ExtensionService()
    {
        return $this->services['sizannia.editor.extension'] = new \Sizannia\EditorBundle\Twig\SizanniaEditorExtension(true, array(), '', array(), array('ckfinder' => array(), 'toolbars' => array()));
    }

    /**
     * Gets the 'sizannia.editor.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sizannia\EditorBundle\Form\Type\SizanniaEditorType A Sizannia\EditorBundle\Form\Type\SizanniaEditorType instance.
     */
    protected function getSizannia_Editor_TypeService()
    {
        return $this->services['sizannia.editor.type'] = new \Sizannia\EditorBundle\Form\Type\SizanniaEditorType();
    }

    /**
     * Gets the 'sonata.admin.application' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\ApplicationAdmin A Serialken\BugTrackerBundle\Admin\ApplicationAdmin instance.
     */
    protected function getSonata_Admin_ApplicationService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\ApplicationAdmin('sonata.admin.application', 'Serialken\\BugTrackerBundle\\Entity\\Application', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.comments' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\CommentsAdmin A Serialken\BugTrackerBundle\Admin\CommentsAdmin instance.
     */
    protected function getSonata_Admin_CommentsService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\CommentsAdmin('sonata.admin.comments', 'Serialken\\BugTrackerBundle\\Entity\\Comments', 'SonataAdminBundle:CRUD');
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Serialken BugTracker Administration', 'bundles/serialkenbugtracker/img/logo_acensi.jpg', array('html5_validate' => true, 'confirm_exit' => true, 'use_select2' => true, 'pager_links' => NULL));
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.user', 1 => 'sonata.admin.project', 2 => 'sonata.admin.application', 3 => 'sonata.admin.comments', 4 => 'sonata.admin.priority', 5 => 'sonata.admin.workflow', 6 => 'sonata.admin.state', 7 => 'sonata.admin.stateworkflow', 8 => 'sonata.media.admin.media', 9 => 'sonata.media.admin.gallery', 10 => 'sonata.media.admin.gallery_has_media'));
        $instance->setAdminGroups(array('Users' => array('label' => 'Users', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'sonata.admin.user')), 'Tracker' => array('label' => 'Tracker', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'sonata.admin.project', 1 => 'sonata.admin.application', 2 => 'sonata.admin.comments', 3 => 'sonata.admin.priority', 4 => 'sonata.admin.workflow', 5 => 'sonata.admin.state', 6 => 'sonata.admin.stateworkflow')), 'sonata_media' => array('label' => 'sonata_media', 'label_catalogue' => 'SonataMediaBundle', 'roles' => array(), 'items' => array(0 => 'sonata.media.admin.media', 1 => 'sonata.media.admin.gallery'))));
        $instance->setAdminClasses(array('Serialken\\UserBundle\\Entity\\User' => array(0 => 'sonata.admin.user'), 'Serialken\\BugTrackerBundle\\Entity\\Project' => array(0 => 'sonata.admin.project'), 'Serialken\\BugTrackerBundle\\Entity\\Application' => array(0 => 'sonata.admin.application'), 'Serialken\\BugTrackerBundle\\Entity\\Comments' => array(0 => 'sonata.admin.comments'), 'Serialken\\BugTrackerBundle\\Entity\\Priority' => array(0 => 'sonata.admin.priority'), 'Serialken\\BugTrackerBundle\\Entity\\Workflow' => array(0 => 'sonata.admin.workflow'), 'Serialken\\BugTrackerBundle\\Entity\\State' => array(0 => 'sonata.admin.state'), 'Serialken\\BugTrackerBundle\\Entity\\StateWorkflow' => array(0 => 'sonata.admin.stateworkflow'), 'Serialken\\MediaBundle\\Entity\\Media' => array(0 => 'sonata.media.admin.media'), 'Serialken\\MediaBundle\\Entity\\Gallery' => array(0 => 'sonata.media.admin.gallery'), 'Serialken\\MediaBundle\\Entity\\GalleryHasMedia' => array(0 => 'sonata.media.admin.gallery_has_media')));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.priority' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\PriorityAdmin A Serialken\BugTrackerBundle\Admin\PriorityAdmin instance.
     */
    protected function getSonata_Admin_PriorityService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\PriorityAdmin('sonata.admin.priority', 'Serialken\\BugTrackerBundle\\Entity\\Priority', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('SerialkenBugTrackerBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
    ...
    /**
     * Gets the 'sonata.admin.project' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\ProjectAdmin A Serialken\BugTrackerBundle\Admin\ProjectAdmin instance.
     */
    protected function getSonata_Admin_ProjectService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\ProjectAdmin('sonata.admin.project', 'Serialken\\BugTrackerBundle\\Entity\\Project', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.user', 1 => 'sonata.admin.project', 2 => 'sonata.admin.application', 3 => 'sonata.admin.comments', 4 => 'sonata.admin.priority', 5 => 'sonata.admin.workflow', 6 => 'sonata.admin.state', 7 => 'sonata.admin.stateworkflow', 8 => 'sonata.media.admin.media', 9 => 'sonata.media.admin.gallery', 10 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.state' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\StateAdmin A Serialken\BugTrackerBundle\Admin\StateAdmin instance.
     */
    protected function getSonata_Admin_StateService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\StateAdmin('sonata.admin.state', 'Serialken\\BugTrackerBundle\\Entity\\State', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.stateworkflow' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\StateWorkflowAdmin A Serialken\BugTrackerBundle\Admin\StateWorkflowAdmin instance.
     */
    protected function getSonata_Admin_StateworkflowService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\StateWorkflowAdmin('sonata.admin.stateworkflow', 'Serialken\\BugTrackerBundle\\Entity\\StateWorkflow', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('StateWorkflow');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SerialkenUserBundle:Override:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
     ...
     *
     * @return Serialken\UserBundle\Admin\UserAdmin A Serialken\UserBundle\Admin\UserAdmin instance.
     */
    protected function getSonata_Admin_UserService()
    {
        $instance = new \Serialken\UserBundle\Admin\UserAdmin('sonata.admin.user', 'Serialken\\UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.workflow' service.
     *
     * @return Serialken\BugTrackerBundle\Admin\WorkflowAdmin A Serialken\BugTrackerBundle\Admin\WorkflowAdmin instance.
     */
    protected function getSonata_Admin_WorkflowService()
    {
        $instance = new \Serialken\BugTrackerBundle\Admin\WorkflowAdmin('sonata.admin.workflow', 'Serialken\\BugTrackerBundle\\Entity\\Workflow', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array('admin' => array(0 => 'sonata.admin.block.admin_list'), 'cms' => array(0 => 'sonata.block.service.text', 1 => 'sonata.block.service.rss', 2 => 'sonata.timeline.block.timeline')));
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.block.service.rss', 3 => 'sonata.timeline.block.timeline'));
    }
    ...
    {
        return $this->services['sonata.media.adapter.filesystem.local'] = new \Sonata\MediaBundle\Filesystem\Local('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web/uploads/media', false);
    }
    ...
    {
        $instance = new \Sonata\MediaBundle\Admin\GalleryAdmin('sonata.media.admin.gallery', 'Serialken\\MediaBundle\\Entity\\Gallery', 'SonataMediaBundle:GalleryAdmin', $this->get('sonata.media.pool'));
    ...
    {
        $instance = new \Sonata\MediaBundle\Admin\GalleryHasMediaAdmin('sonata.media.admin.gallery_has_media', 'Serialken\\MediaBundle\\Entity\\GalleryHasMedia', 'SonataAdminBundle:CRUD');
    ...
    {
        $instance = new \Sonata\MediaBundle\Admin\ORM\MediaAdmin('sonata.media.admin.media', 'Serialken\\MediaBundle\\Entity\\Media', 'SonataMediaBundle:MediaAdmin', $this->get('sonata.media.pool'));
    ...
    {
        return $this->services['sonata.media.form.type.media'] = new \Sonata\MediaBundle\Form\Type\MediaType($this->get('sonata.media.pool'), 'Serialken\\MediaBundle\\Entity\\Media');
    }
    ...
    {
        return $this->services['sonata.media.manager.gallery'] = new \Sonata\MediaBundle\Entity\GalleryManager('Serialken\\MediaBundle\\Entity\\Gallery', $this->get('doctrine'));
    }
    ...
    {
        return $this->services['sonata.media.manager.media'] = new \Sonata\MediaBundle\Entity\MediaManager('Serialken\\MediaBundle\\Entity\\Media', $this->get('doctrine'), $this->get('sonata.media.pool'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/translations', 'debug' => true));

        $instance->setFallbackLocales(array(0 => 'fr'));
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf', 'af', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf', 'cy', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 'no', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf', 'sq', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf', 'th', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 'tr', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf', 'vi', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf', 'zh_TW', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 'lv', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.el.xlf', 'el', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ua.xlf', 'ua', 'security');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ar.yml', 'ar', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.he.yml', 'he', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.id.yml', 'id', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nb.yml', 'nb', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_PT.yml', 'pt_PT', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.th.yml', 'th', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.vi.yml', 'vi', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ar.yml', 'ar', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ca.yml', 'ca', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.he.yml', 'he', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.id.yml', 'id', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nb.yml', 'nb', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.th.yml', 'th', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.vi.yml', 'vi', 'validators');
        $instance->addResource('yml', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lt.xliff', 'lt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.bg.xliff', 'bg', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ca.xliff', 'ca', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.cs.xliff', 'cs', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.de.xliff', 'de', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.en.xliff', 'en', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.es.xliff', 'es', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.eu.xliff', 'eu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fa.xliff', 'fa', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fr.xliff', 'fr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hr.xliff', 'hr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hu.xliff', 'hu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.it.xliff', 'it', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ja.xliff', 'ja', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lb.xliff', 'lb', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lt.xliff', 'lt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.nl.xliff', 'nl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pl.xliff', 'pl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt.xliff', 'pt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt_BR.xliff', 'pt_BR', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ro.xliff', 'ro', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ru.xliff', 'ru', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sk.xliff', 'sk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sl.xliff', 'sl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.uk.xliff', 'uk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.zh_CN.xliff', 'zh_CN', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.de.xliff', 'de', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.en.xliff', 'en', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.es.xliff', 'es', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.fr.xliff', 'fr', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.hu.xliff', 'hu', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.lt.xliff', 'lt', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.nl.xliff', 'nl', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.pl.xliff', 'pl', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.pt_BR.xliff', 'pt_BR', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.ru.xliff', 'ru', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/translations\\SonataMediaBundle.sl.xliff', 'sl', 'SonataMediaBundle');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sizannia\\editor-bundle\\Sizannia\\EditorBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\src\\Serialken\\UserBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\src\\Serialken\\BugTrackerBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'SizanniaEditorBundle:Form:form_widget_sizannia_editor.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        ...
        $instance->addExtension($this->get('sizannia.editor.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\block-bundle/Resources/views', 'SonataBlock');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\admin-bundle/Resources/views', 'SonataAdmin');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\core-bundle/Resources/views', 'SonataCore');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle/Resources/views', 'SonataMedia');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sizannia\\editor-bundle\\Sizannia\\EditorBundle/Resources/views', 'SizanniaEditor');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\src\\Serialken\\MediaBundle/Resources/views', 'SerialkenMedia');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\src\\Serialken\\UserBundle/Resources/views', 'SerialkenUser');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\src\\Serialken\\BugTrackerBundle/Resources/views', 'SerialkenBugTracker');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/Resources/views');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($a), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter(new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage(), $b, $a), 2 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($b), 3 => new \Symfony\Component\Security\Acl\Voter\AclVoter($this->get('security.acl.provider'), new \Symfony\Component\Security\Acl\Domain\ObjectIdentityRetrievalStrategy(), new \Symfony\Component\Security\Acl\Domain\SecurityIdentityRetrievalStrategy($a, $b), new \Sonata\AdminBundle\Security\Acl\Permission\AdminPermissionMap(), $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), true)), 'unanimous', false, true);
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_MEDIA' => array(0 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_LIST', 1 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_VIEW', 2 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_CREATE', 3 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_EDIT', 4 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_EXPORT', 5 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_DELETE'), 'ROLE_GALLERY' => array(0 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_LIST', 1 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_VIEW', 2 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_CREATE', 3 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_EDIT', 4 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_EXPORT', 5 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_DELETE'), 'ROLE_SONATA_USER' => array(0 => 'ROLE_SONATA_ADMIN_USER_LIST', 1 => 'ROLE_SONATA_ADMIN_USER_VIEW', 2 => 'ROLE_SONATA_ADMIN_USER_CREATE', 3 => 'ROLE_SONATA_ADMIN_USER_EDIT', 4 => 'ROLE_SONATA_ADMIN_USER_EXPORT', 5 => 'ROLE_SONATA_ADMIN_USER_DELETE'), 'ROLE_SONATA_PROJECT' => array(0 => 'ROLE_SONATA_ADMIN_PROJECT_LIST', 1 => 'ROLE_SONATA_ADMIN_PROJECT_VIEW', 2 => 'ROLE_SONATA_ADMIN_PROJECT_CREATE', 3 => 'ROLE_SONATA_ADMIN_PROJECT_EDIT', 4 => 'ROLE_SONATA_ADMIN_PROJECT_EXPORT', 5 => 'ROLE_SONATA_ADMIN_PROJECT_DELETE'), 'ROLE_SONATA_APPLICATION' => array(0 => 'ROLE_SONATA_ADMIN_APPLICATION_LIST', 1 => 'ROLE_SONATA_ADMIN_APPLICATION_VIEW', 2 => 'ROLE_SONATA_ADMIN_APPLICATION_CREATE', 3 => 'ROLE_SONATA_ADMIN_APPLICATION_EDIT', 4 => 'ROLE_SONATA_ADMIN_APPLICATION_EXPORT', 5 => 'ROLE_SONATA_ADMIN_APPLICATION_DELETE'), 'ROLE_SONATA_PRIORITY' => array(0 => 'ROLE_SONATA_ADMIN_PRIORITY_LIST', 1 => 'ROLE_SONATA_ADMIN_PRIORITY_VIEW', 2 => 'ROLE_SONATA_ADMIN_PRIORITY_CREATE', 3 => 'ROLE_SONATA_ADMIN_PRIORITY_EDIT', 4 => 'ROLE_SONATA_ADMIN_PRIORITY_EXPORT', 5 => 'ROLE_SONATA_ADMIN_PRIORITY_DELETE'), 'ROLE_SONATA_STATE' => array(0 => 'ROLE_SONATA_ADMIN_STATE_LIST', 1 => 'ROLE_SONATA_ADMIN_STATE_VIEW', 2 => 'ROLE_SONATA_ADMIN_STATE_CREATE', 3 => 'ROLE_SONATA_ADMIN_STATE_EDIT', 4 => 'ROLE_SONATA_ADMIN_STATE_EXPORT', 5 => 'ROLE_SONATA_ADMIN_STATE_DELETE'), 'ROLE_SONATA_WORKFLOW' => array(0 => 'ROLE_SONATA_ADMIN_WORKFLOW_LIST', 1 => 'ROLE_SONATA_ADMIN_WORKFLOW_VIEW', 2 => 'ROLE_SONATA_ADMIN_WORKFLOW_CREATE', 3 => 'ROLE_SONATA_ADMIN_WORKFLOW_EDIT', 4 => 'ROLE_SONATA_ADMIN_WORKFLOW_EXPORT', 5 => 'ROLE_SONATA_ADMIN_WORKFLOW_DELETE'), 'ROLE_SONATA_STATEWORKFLOW' => array(0 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_LIST', 1 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_VIEW', 2 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_CREATE', 3 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_EDIT', 4 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_EXPORT', 5 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_DELETE'), 'ROLE_SONATA_COMMENTS_ADMIN' => array(0 => 'ROLE_SONATA_ADMIN_COMMENTS_CREATE', 1 => 'ROLE_SONATA_ADMIN_COMMENTS_EDIT'), 'ROLE_SONATA_COMMENTS_MODERATE' => array(0 => 'ROLE_SONATA_ADMIN_COMMENTS_LIST', 1 => 'ROLE_SONATA_ADMIN_COMMENTS_VIEW', 2 => 'ROLE_SONATA_ADMIN_COMMENTS_EXPORT', 3 => 'ROLE_SONATA_ADMIN_COMMENTS_DELETE'), 'ROLE_SONATA_COMMENTS' => array(0 => 'ROLE_SONATA_COMMENTS_ADMIN', 1 => 'ROLE_SONATA_COMMENTS_MODERATE'), 'ROLE_ENTITY' => array(0 => 'ROLE_SONATA_PROJECT', 1 => 'ROLE_SONATA_APPLICATION', 2 => 'ROLE_SONATA_PRIORITY', 3 => 'ROLE_SONATA_STATE', 4 => 'ROLE_SONATA_WORKFLOW', 5 => 'ROLE_SONATA_STATEWORKFLOW'), 'ROLE_MODERATE' => array(0 => 'ROLE_USER', 1 => 'ROLE_ENTITY', 2 => 'ROLE_SONATA_COMMENTS_MODERATE', 3 => 'ROLE_MEDIA', 4 => 'ROLE_GALLERY', 5 => 'ROLE_SONATA_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_MODERATE', 1 => 'ROLE_SONATA_COMMENTS', 2 => 'ROLE_SONATA_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle\\Resources\\config\\validation.xml', 3 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev',
            'kernel.logs_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/logs',
            'kernel.bundles' => array(
                ...
                'SizanniaEditorBundle' => 'Sizannia\\EditorBundle\\SizanniaEditorBundle',
                'SerialkenMediaBundle' => 'Serialken\\MediaBundle\\SerialkenMediaBundle',
                'SerialkenUserBundle' => 'Serialken\\UserBundle\\SerialkenUserBundle',
                'SerialkenBugTrackerBundle' => 'Serialken\\BugTrackerBundle\\SerialkenBugTrackerBundle',
            ...
            'debug.container.dump' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\sonata-project\\media-bundle\\Resources\\config\\validation.xml',
                3 => 'C:\\Users\\yannick.dieng\\Workspace\\Symfony-Bug_Tracker\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/assetic/routing.yml',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_MEDIA' => array(
                    0 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_LIST',
                    1 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_VIEW',
                    2 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_CREATE',
                    3 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_EDIT',
                    4 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_EXPORT',
                    5 => 'ROLE_SONATA_MEDIA_ADMIN_MEDIA_DELETE',
                ),
                'ROLE_GALLERY' => array(
                    0 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_LIST',
                    1 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_VIEW',
                    2 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_CREATE',
                    3 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_EDIT',
                    4 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_EXPORT',
                    5 => 'ROLE_SONATA_MEDIA_ADMIN_GALLERY_DELETE',
                ),
                'ROLE_SONATA_USER' => array(
                    0 => 'ROLE_SONATA_ADMIN_USER_LIST',
                    1 => 'ROLE_SONATA_ADMIN_USER_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_USER_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_USER_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_USER_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_USER_DELETE',
                ),
                'ROLE_SONATA_PROJECT' => array(
                    0 => 'ROLE_SONATA_ADMIN_PROJECT_LIST',
                    1 => 'ROLE_SONATA_ADMIN_PROJECT_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_PROJECT_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_PROJECT_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_PROJECT_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_PROJECT_DELETE',
                ),
                'ROLE_SONATA_APPLICATION' => array(
                    0 => 'ROLE_SONATA_ADMIN_APPLICATION_LIST',
                    1 => 'ROLE_SONATA_ADMIN_APPLICATION_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_APPLICATION_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_APPLICATION_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_APPLICATION_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_APPLICATION_DELETE',
                ),
                'ROLE_SONATA_PRIORITY' => array(
                    0 => 'ROLE_SONATA_ADMIN_PRIORITY_LIST',
                    1 => 'ROLE_SONATA_ADMIN_PRIORITY_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_PRIORITY_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_PRIORITY_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_PRIORITY_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_PRIORITY_DELETE',
                ),
                'ROLE_SONATA_STATE' => array(
                    0 => 'ROLE_SONATA_ADMIN_STATE_LIST',
                    1 => 'ROLE_SONATA_ADMIN_STATE_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_STATE_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_STATE_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_STATE_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_STATE_DELETE',
                ),
                'ROLE_SONATA_WORKFLOW' => array(
                    0 => 'ROLE_SONATA_ADMIN_WORKFLOW_LIST',
                    1 => 'ROLE_SONATA_ADMIN_WORKFLOW_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_WORKFLOW_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_WORKFLOW_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_WORKFLOW_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_WORKFLOW_DELETE',
                ),
                'ROLE_SONATA_STATEWORKFLOW' => array(
                    0 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_LIST',
                    1 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_CREATE',
                    3 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_EDIT',
                    4 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_EXPORT',
                    5 => 'ROLE_SONATA_ADMIN_STATEWORKFLOW_DELETE',
                ),
                'ROLE_SONATA_COMMENTS_ADMIN' => array(
                    0 => 'ROLE_SONATA_ADMIN_COMMENTS_CREATE',
                    1 => 'ROLE_SONATA_ADMIN_COMMENTS_EDIT',
                ),
                'ROLE_SONATA_COMMENTS_MODERATE' => array(
                    0 => 'ROLE_SONATA_ADMIN_COMMENTS_LIST',
                    1 => 'ROLE_SONATA_ADMIN_COMMENTS_VIEW',
                    2 => 'ROLE_SONATA_ADMIN_COMMENTS_EXPORT',
                    3 => 'ROLE_SONATA_ADMIN_COMMENTS_DELETE',
                ),
                'ROLE_SONATA_COMMENTS' => array(
                    0 => 'ROLE_SONATA_COMMENTS_ADMIN',
                    1 => 'ROLE_SONATA_COMMENTS_MODERATE',
                ),
                'ROLE_ENTITY' => array(
                    0 => 'ROLE_SONATA_PROJECT',
                    1 => 'ROLE_SONATA_APPLICATION',
                    2 => 'ROLE_SONATA_PRIORITY',
                    3 => 'ROLE_SONATA_STATE',
                    4 => 'ROLE_SONATA_WORKFLOW',
                    5 => 'ROLE_SONATA_STATEWORKFLOW',
                ),
                'ROLE_MODERATE' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_ENTITY',
                    2 => 'ROLE_SONATA_COMMENTS_MODERATE',
                    3 => 'ROLE_MEDIA',
                    4 => 'ROLE_GALLERY',
                    5 => 'ROLE_SONATA_USER',
                ),
            ...
            'twig.form.resources' => array(
                ...
                1 => 'SizanniaEditorBundle:Form:form_widget_sizannia_editor.html.twig',
            ),
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'monolog.handlers_to_channels' => array(
                'monolog.handler.doctrine' => array(
                    'type' => 'inclusive',
                    'elements' => array(
                        0 => 'doctrine',
                    ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web',
            'assetic.write_to' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/yannick.dieng/Workspace/Symfony-Bug_Tracker/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Serialken\\UserBundle\\Entity\\User',
            ...
            'sonata.media.admin.media.entity' => 'Serialken\\MediaBundle\\Entity\\Media',
            'sonata.media.admin.gallery.entity' => 'Serialken\\MediaBundle\\Entity\\Gallery',
            'sonata.media.admin.gallery_has_media.entity' => 'Serialken\\MediaBundle\\Entity\\GalleryHasMedia',
            'sonata.media.media.class' => 'Serialken\\MediaBundle\\Entity\\Media',
            'sonata.media.gallery.class' => 'Serialken\\MediaBundle\\Entity\\Gallery',
            ...
            'sizannia_editor.connector.type' => 'php',
            'sizannia_editor.styles' => array(

            ),
            'sizannia_editor.toolbars' => array(

            ),
            'sizannia_editor.removeplugins' => '',
            'sizannia_editor.addplugins' => array(
                'ckfinder' => array(
            ...
            'sizannia_editor.hasckfinder' => true,
            'sizannia_editor.license' => array(
                'key' => '',
                'name' => '',
            ),
            'sizannia_editor.base_url' => '/uploads/',
            'sizannia_editor.path' => '',
            'sizannia.editor.form.type.class' => 'Sizannia\\EditorBundle\\Form\\Type\\SizanniaEditorType',
            'sizannia.editor.extension.class' => 'Sizannia\\EditorBundle\\Twig\\SizanniaEditorExtension',
